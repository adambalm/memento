...
/**
 * Render the session visualization diagram (Pass 3)
 * Uses Mermaid.js to render the diagram generated by the classifier
 */
function renderVisualization(visualization) {
  if (!visualization || !visualization.mermaid) return '';

  return `
    <section class="visualization-section">
      <h2>Session Structure</h2>
      <p class="visualization-desc">Visual map of how your tabs relate to each other and your active projects.</p>
      <div class="mermaid-container">
        <pre class="mermaid">${visualization.mermaid}</pre>
      </div>
      ${visualization.interpretation ? `
        <div class="visualization-interpretation">
          <p>${escapeHtml(visualization.interpretation)}</p>
        </div>
      ` : ''}
    </section>
  `;
